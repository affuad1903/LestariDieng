                ...
                <form method="POST" action="/dashboard/paket" enctype="multipart/form-data">
                    ...
                    <div class="admin-form-group">
                        ...
                        <select class="admin-form-control @error('is_main_page') is-invalid @enderror" name="is_main_page" id="is_main_page" required>
                            <option value="0" {{ old('is_main_page') == '0' ? 'selected' : '' }}>Tidak</option>
                            <option value="1" {{ old('is_main_page') == '1' ? 'selected' : '' }}>Ya</option>
                        </select>
                        @error('is_main_page')
                    ...
                    <div class="admin-form-group">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('paket_sub_title_date') }}"
                    ...
                    <div class="admin-form-group">
                        ...
                        <div class="admin-file-upload-container">
                            ...
                            <div class="admin-file-upload-label">
                                Klik atau drag & drop gambar paket di sini
                                    ...
                                    <div class="checkbox-item">
                                        <div class="custom-checkbox">
                                            <input type="checkbox" 
                                                   ...
                                                   {{ in_array($item->id, old('daftar_destinasi', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="checkbox-item">
                                        <div class="custom-checkbox">
                                            <input type="checkbox" 
                                                   ...
                                                   {{ in_array($item->id, old('daftar_fasilitas', [])) ? 'checked' : '' }}>
