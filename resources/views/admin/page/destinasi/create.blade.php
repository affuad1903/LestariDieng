    ...
    <div class="col-xl-8 col-lg-10">
        <div class="card admin-form-container">
            <div class="admin-form-header">
                <h4>
                    <i class="mdi mdi-map-marker-plus"></i>Tambah Destinasi Baru
                </h4>
            </div>
            <div class="admin-form-body">
                <form method="POST" action="/dashboard/destinasi" enctype="multipart/form-data">
                    @csrf
                    
                    <!-- Is Main Page -->
                    <div class="admin-form-group">
                        <label for="is_main_page" class="admin-form-label">
                            <i class="mdi mdi-home"></i>Tampilkan di Halaman Utama
                            <span class="required">*</span>
                        </label>
                        <select class="admin-form-control @error('is_main_page') is-invalid @enderror" 
                                name="is_main_page" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('content_location_title') }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('content_location_detail') is-invalid @enderror" 
                                  ...
                                  rows="3"
                                  placeholder="Masukkan detail lokasi (opsional)">{{ old('content_location_detail') }}</textarea>
                    ...
                    <div class="form-group">
                        <label for="thumbnail_image" class="form-label">
                            <i class="mdi mdi-image me-2"></i>Gambar Thumbnail Destinasi
                        </label>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">
                            <i class="mdi mdi-content-save me-2"></i>Simpan Destinasi
                        </button>
