        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card admin-form-container">
                ...
                <div class="admin-form-body">
                    <form method="POST" action="/dashboard/home/contact" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="admin-form-group">
                            ...
                            <select name="icon" 
                                ...
                                <option value="ri-whatsapp-line" {{ old('icon') == 'ri-whatsapp-line' ? 'selected' : '' }}>WhatsApp</option>
                                <option value="ri-mail-line" {{ old('icon') == 'ri-mail-line' ? 'selected' : '' }}>Email</option>
                                <option value="ri-phone-line" {{ old('icon') == 'ri-phone-line' ? 'selected' : '' }}>Telepon</option>
                                <option value="ri-map-pin-line" {{ old('icon') == 'ri-map-pin-line' ? 'selected' : '' }}>Alamat</option>
                                <option value="ri-global-line" {{ old('icon') == 'ri-global-line' ? 'selected' : '' }}>Website</option>
                            </select>
                            @error('icon')
                                <div class="admin-error-message">
                                    <i class="fas fa-exclamation-circle"></i>{{ $message }}
