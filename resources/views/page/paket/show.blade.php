...
@section('meta_description', 'Nikmati perjalanan seru ke Dieng dalam 1 hari bersama Lestari Wisata. Kunjungi tempat wisata terbaik dengan layanan terbaik dan harga terjangkau.')
@section('content')
    <section class="container-fluid mb-5">
        ...
        <header class="row custom-container-header text-white mb-2">
            <h2 class="text-center fw-bold  responsive-text">Trip Dieng 1 Hari</h2>
            ...
            <section class="row py-3 my-3">  
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 responsive-text-content">
                    <article class="card custom-cardShadow">
                        <span class="badge rounded-pill bg-info text-white position-absolute top-0 start-0 m-2 p-2">Trip Dieng 1 Hari</span>
                        <div class="card-body">
